...
class LaborProfile extends Component {
  render() {
    return (
                ...
                content={
                  <form>
                    <FormInputs
                      ...
                      proprieties={[
                        {
                          label: "เลขประจำตัวผู้ใช้แรงงาน (disabled)",
                          type: "text",
                          bsClass: "form-control",
                          placeholder: "ระบุเลขประจำตัวผู้ใช้แรงงาน",
                          defaultValue: "-",
                          disabled: true
                        },
                        {
                    ...
                    <FormInputs
                      ...
                      proprieties={[
                        ...
                        },
                        {
                          ...
                          type: "text",
                          bsClass: "form-control",
                          placeholder: "ประเภทแรงงาน",
                          defaultValue: "ช่างไม้"
                        }
                      ]}
                    />
                      ...
                      proprieties={[
                        {
                          ...
                          type: "text",
                          bsClass: "form-control",
                          placeholder: "ระบุจำนวนสามี (ถ้ามี)",
                          defaultValue: "1"
                        },
                        {
                          label: "ภรรยา",
                          type: "text",
                          bsClass: "form-control",
                          placeholder: "ระบุจำนวนภรรยา (ถ้ามี)",
                        },
                        {
                          label: "จำนวนบุตร",
                          type: "text",
                    ...
                    <Row>
                      <Col md={12}>
                        <FormGroup controlId="formControlsTextarea">
                          <ControlLabel>อื่นๆ</ControlLabel>
                          <FormControl
                            rows="5"
